...
[
  {
    "name": "Entity Name",
    "type": "FILE|FUNCTION|API|SERVICE|COMPONENT|DATABASE|ROUTE|PERSON|ORGANIZATION|CONCEPT|OTHER",
    "summary": "Brief description of the entity based on context"
  }
]

Rules:
- FILE: source files (.js, .ts, .jsx, .py, .css, .html, etc.)
...
- DATABASE: databases, tables, collections
- ROUTE: URL paths, navigation routes
- PERSON/ORGANIZATION: people, companies
- CONCEPT: patterns, architectures, ideas
- OTHER: anything else
